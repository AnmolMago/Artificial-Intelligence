...
class AirCargoProblem(Problem):
            ...
            for airport in self.airports:
                for plane in self.planes:
                    for cargo in self.cargos:
                        ...
                        load_action = Action(expr("Unload({}, {}, {})".format(cargo, plane, airport)),
                                             [precond_pos, precond_neg],
                                             [effect_add, effect_rem])
    ...
    def actions(self, state: str) -> list:
        ...
        return [a for a in self.actions_list if a.check_precond(knowledge_base, a.args)]
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        knowledge_base = PropKB()
        knowledge_base.tell(decode_state(current_state, self.state_map).pos_sentence())
        for clause in self.goal:
